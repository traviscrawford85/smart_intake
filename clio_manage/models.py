...
class IntakeLead(Base):
    ...
    source: Mapped[str] = mapped_column(String(100), nullable=False, default="Capture Now Bot")
    
    # Clio integration tracking
    clio_lead_id: Mapped[Optional[int]] = mapped_column(Integer, nullable=True, index=True)
...
class Contact(Base):
    ...
    clio_contact_id: Mapped[Optional[int]] = mapped_column(Integer, nullable=True, unique=True, index=True)
    ...
    contact_type: Mapped[Optional[str]] = mapped_column(String(50), nullable=True, default="Person")
...
class CustomAction(Base):
    ...
    clio_action_id: Mapped[Optional[int]] = mapped_column(Integer, nullable=True, unique=True, index=True)
...
class WebhookSubscription(Base):
    ...
    clio_subscription_id: Mapped[Optional[int]] = mapped_column(Integer, nullable=True, unique=True, index=True)
...
class WebhookEvent(Base):
    ...
    clio_event_id: Mapped[Optional[str]] = mapped_column(String(100), nullable=True, index=True)
